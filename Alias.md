...
alias vizgard_vpn_stop="/usr/bin/openvpn3 session-manage --session-path $(openvpn3 sessions-list | grep -B 4 '<PATH_TO_OVPN_FILE_BASENAME>.ovpn' | grep 'Path:' | awk '{print $2}') --disconnect"
